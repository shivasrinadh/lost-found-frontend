...
export default function Register() {
  ...
  return (
    <div className="register-page" style={{
      ...
      <div className="register-grid" style={{ width: '100%', maxWidth: 920, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, animation: 'fadeUp 0.5s var(--ease-out) both' }}>

        {/* Left: perks */}
        <div className="register-left" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 24px' }}>
          <div style={{
      ...
      <style>{`
        @media (max-width: 1024px) {
          .register-grid { max-width: 760px !important; }
        }

        @media (max-width: 768px) {
          .register-page { align-items: flex-start !important; padding: 84px 14px 24px !important; }
          .register-grid { grid-template-columns: 1fr !important; gap: 16px !important; }
          .register-left { display: none !important; }
          .register-card { padding: 22px !important; border-radius: 16px !important; }
        }

        @media (max-width: 420px) {
          .register-card { padding: 16px !important; }
        }
      `}</style>
    </div>
  )
